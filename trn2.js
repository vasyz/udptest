...
const port = 2222;
const name = 'Василь2'; // тут ім'я
const last_name = 'Василенко2'; // тут прізвище
const father_name = 'Васильович2' ;// тут по батькові
const key = "1489" ; // тут додав від себе ункальний номер клієнта , в подальшому буде легше зрозуміти хто саме не вийшов на зв'язок, як варіант
setInterval(() => {
